...
class DataStoreRepository(appContext:Context):MyDataStore(appContext) {
    ...
    val disableSoundFlow = DATASTORE_DISABLE_SOUND.notNullFlow(defaultValue = false)
    ...
    val disableNotificationBarFlow = DATASTORE_DISABLE_NOTIFICATION_BAR.notNullFlow(defaultValue = false)
